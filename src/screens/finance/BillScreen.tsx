...
const styles = StyleSheet.create({
    ...
    tabsRow: {
        ...
        borderRadius: 24, padding: 4, marginBottom: 12,
    },
    tab: {
    ...
    cardAmount: { fontSize: 15, fontWeight: '800', color: colors.textDark, marginBottom: 4 },
    statusPill: { backgroundColor: '#EFF6FF', borderRadius: 10, paddingHorizontal: 8, paddingVertical: 3 },
