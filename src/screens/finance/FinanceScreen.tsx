...
export default function FinanceScreen() {
  ...
  const refreshing = useAppSelector(state => state.finance.refresh);
  const overview = useAppSelector(state => state.finance.overview);
...
useFocusEffect(
  ...
  const monthlyBudget = overview ? overview.totalBudgetAmount : 0;
      ...
      >
        ...
        {overview && (
          <View style={styles.cardGrid}>
            <View style={[styles.card, { backgroundColor: '#EFF6FF' }]}>
              ...
              <Text style={[styles.cardFooter, { color: '#2563EB' }]}>
                Pending bills
              </Text>
            </View>
            ...
            <View style={[styles.card, { backgroundColor: '#FFFBEB' }]}>
              ...
              <Text style={styles.cardValue}>
                {formatCurrency(overview.overdueBillsAmount)}
              </Text>
        ...
        <View style={styles.sectionsList}>
          {[
            ...
            {
              title: 'Bills',
              subtitle: 'View and manage your bills',
              icon: 'file-text',
              route: 'Bills',
            },
            {
              title: 'Budget',
              subtitle: 'Plan and track your budget',
              icon: 'pie-chart',
